...
\newenvironment{renumerate}{\begin{enumerate}\setcounter{enumi}{\value{running}}}%
{\setcounter{running}{\value{enumi}}\end{enumerate}}

\newcommand{\cpsa}{\textsc{cpsa}}
\newcommand{\version}{4.3}
\newcommand{\cpsacopying}{\begingroup
  \renewcommand{\thefootnote}{}\footnotetext{{\copyright} 2016-2020 The
...
\newcommand{\ttindexalt}[2]{\index{#1@\texttt{#1}{#2}}}
\theoremstyle{definition}
\newtheorem{exercise}{Exploration}[chapter]
