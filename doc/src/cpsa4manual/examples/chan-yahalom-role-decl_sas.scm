    ...
    (implies
      ...
      (exists ((n-a-0 text) (ch1-0 ch3 chan) (z-0 z-1 strd))
        (and (p "serv" z-0 3) (p "init" z-1 3) (p "serv" "k" z-0 k)
          ...
          (prec z-0 2 z 2) (prec z-1 2 z 3) (uniq-at k z-0 1) (auth ch3)
          (conf ch2) (conf ch3))))))
  ...
  (forall
    ...
    (implies
      (and (p "resp" z 4) (p "" z-0 2) (p "resp" "k" z k)
        ...
        (p "" "x" z-0 k) (uniq-at n-b z 1) (auth ch2))
      (false))))
  ...
  (forall ((k skey) (n-a n-b text) (a b name) (ch3 chan) (z z-0 strd))
    (implies
      (and (p "init" z 3) (p "" z-0 2) (p "init" "k" z k)
        ...
        (p "init" "b" z b) (p "init" "ch3" z ch3) (p "" "x" z-0 k)
        (auth ch3))
      (false))))
  ...
  (forall
    ...
    (implies
      (and (p "init" z 3) (p "resp" z-0 3) (p "init" "k" z k)
        (p "init" "n-a" z n-a) (p "init" "n-b" z n-b) (p "init" "a" z a)
        (p "init" "b" z b) (p "init" "ch3" z ch3) (p "resp" "k" z-0 k)
        (p "resp" "n-a" z-0 n-a-0) (p "resp" "n-b" z-0 n-b-0)
        (p "resp" "b" z-0 b-0) (p "resp" "a" z-0 a-0)
        (p "resp" "ch1" z-0 ch1) (p "resp" "ch2" z-0 ch2)
        (uniq-at n-a z 0) (auth ch3) (auth ch2))
