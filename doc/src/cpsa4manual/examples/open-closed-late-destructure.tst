...
(defskeleton subatomic-open-closed
  ...
  (defstrand dev-open 4 (any any)
    (request (enc (open-req b d o-0 nb n) (hash-dk b nb n k-0))) (k k-0)
    (n n) (nb nb) (d d) (o o-0) (b b) (lk lk) (ls ls))
  ...
  (rule cau-dev-closed-2 cau-dev-pass-1 cheq-dev-open-4
    fact-dev-closed-same-dev0 fact-dev-pass-same-dev0
    gen-st-dev-closed-0 invShearsRule same-dev-ls-lk trRl_dev-open-at-1
  ...
  (traces
    ...
    ((send start-ch (cat "power-up" d o k)))
    ((recv
       (cat b n nb (enc (open-req b d o-0 nb n) (hash-dk b nb n k-0))))
...
(defskeleton subatomic-open-closed
  ...
  (operation encryption-test (added-strand passer-open 2)
    (enc (open-req b d o nb n) (hash-dk b nb n k)) (3 0))
  (traces ((send start-ch (cat "power-up" d o k)) (recv (enc "up" k)))
    ((load lk (cat pt-2 (dev-key-state d o k)))
      (load ls (cat pt (door-state d (opened b nb n))))
      (recv (cat b nb n (enc "may I pass" (hash-dk b nb n k))))
    ...
    ((recv (cat b n nb (enc (open-req b d o nb n) (hash-dk b nb n k))))
      ...
      (stor ls (cat pt (door-state d (opened b nb n)))))
    ((load del-key-locn
       (cat pt-5 (key-rec b d o nb n (hash-dk b nb n k))))
...
(defskeleton subatomic-open-closed
  (vars (old old1 any mesg) (k skey) (n nb text) (d o b d-0 o-0 name)
    (pt pt-0 pt-1 pt-2 pt-3 pt-4 pval) (start-ch to-b from-b chan)
    (ls lk locn))
  (defstrand owner-power-dev 2 (k k) (d d) (o o) (start-ch start-ch))
  (defstrand dev-pass 4 (k k) (n n) (nb nb) (d d) (o o) (b b) (lk lk)
    (ls ls))
  ...
  (label 20)
  (parent 17)
  (unrealized (0 1) (1 2) (3 0) (4 0) (5 0))
  (comment "1 in cohort - 1 not yet seen"))
...
(defskeleton subatomic-open-closed
  ...
  (traces ((send start-ch (cat "power-up" d o k)) (recv (enc "up" k)))
    ...
    ((send from-b (cat "req-key" b nb))
      ...
      (send (hash b nb n)) (load del-key-locn-0 (cat pt-6 ign))
      (stor del-key-locn-0
...
(defskeleton subatomic-open-closed
  ...
  (defstrand passer-recv-key 1 (nb nb) (b b) (from-b from-b))
  (deflistener (cat b nb n k))
  (precedes ((0 0) (2 0)) ((0 0) (7 0)) ((2 4) (3 1)) ((3 3) (1 0))
    ((4 1) (3 0)) ((5 1) (7 0)) ((6 0) (5 0)) ((7 1) (4 0)))
  (uniq-orig k n nb)
  (gen-st (dev-key-state d o k) (door-state d (opened b nb n)))
  (conf start-ch to-b)
  (auth start-ch from-b)
...
(defskeleton subatomic-open-closed
  (vars (old old1 any ign mesg) (k skey) (n nb text)
    (d o b d-0 o-0 name) (pt pt-0 pt-1 pt-2 pt-3 pt-4 pt-5 pt-6 pval)
  ...
  (traces ((send start-ch (cat "power-up" d o k)) (recv (enc "up" k)))
    ...
    ((send from-b (cat "req-key" b nb))
      ...
      (stor del-key-locn
        (cat pt-6 (key-rec b d-0 o-0 nb n (hash-dk b nb n k))))))
  (label 28)
  (parent 24)
  (unrealized (0 1) (1 2) (3 0) (4 0))
  (comment "1 in cohort - 1 not yet seen"))
...
(defskeleton subatomic-open-closed
  ...
  (auth start-ch to-b from-b)
  (facts (same-dev ls lk))
  (leads-to ((2 3) (1 0)) ((2 3) (3 2)) ((3 3) (1 1)) ((6 4) (4 0)))
  (rule fact-dev-pass-same-dev0 trRl_dev-open-at-1 trRl_dev-open-at-3
    trRl_dev-up-at-1 trRl_dev-up-at-2 trRl_dev-up-at-3 trRl_dev-up-at-4
    trRl_passer-recv-key-at-3 trRl_passer-recv-key-at-4)
  (operation encryption-test
    (contracted (d-0 d) (o-0 o) (del-key-locn-0 del-key-locn)
      (pt-7 pt-6)) (hash-dk b nb n k) (4 0)
...
(defskeleton subatomic-open-closed
  ...
  (deflistener (cat b nb n k))
  (precedes ((0 0) (2 0)) ((0 0) (7 0)) ((2 4) (3 1)) ((3 3) (1 0))
    ((4 1) (3 0)) ((5 1) (6 1)) ((5 1) (7 0)) ((6 0) (5 0))
    ((6 4) (4 0)) ((7 1) (4 0)))
  (uniq-orig k n nb)
  (gen-st (dev-key-state d o k) (door-state d (opened b nb n)))
  (conf start-ch to-b)
...
(defskeleton subatomic-open-closed
  ...
  (defstrand passer-recv-key 1 (nb nb) (b b) (from-b from-b))
  (deflistener (cat b nb n k))
  (precedes ((0 0) (2 0)) ((2 4) (7 0)) ((3 3) (1 0)) ((4 1) (3 0))
    ((5 1) (7 0)) ((6 0) (5 0)) ((7 1) (4 0)))
  (uniq-orig k n nb)
  (gen-st (dev-key-state d o k) (door-state d (opened b nb n)))
  (conf start-ch to-b)
  (auth start-ch from-b)
...
(defskeleton subatomic-open-closed
  ...
  (defstrand passer-pass 2 (kp (hash-dk b nb n k)) (n n-0) (nb nb-0)
    (d d-0) (o o-0) (b b-0) (del-key-locn del-key-locn-0))
  (deflistener (cat b nb n k))
  (precedes ((0 0) (2 0)) ((0 0) (8 0)) ((2 4) (3 1)) ((3 3) (1 0))
    ((4 1) (3 0)) ((5 1) (6 1)) ((5 1) (8 0)) ((6 0) (5 0))
...
(defskeleton subatomic-open-closed
  ...
  (defstrand passer-pass 2 (kp (hash-dk b nb n k)) (n n-0) (nb nb-0)
    (d d-0) (o o-0) (b b-0) (del-key-locn del-key-locn-0))
  (deflistener (cat b nb n k))
  (precedes ((0 0) (2 0)) ((2 4) (3 1)) ((2 4) (8 0)) ((3 3) (1 0))
    ((4 1) (3 0)) ((5 1) (6 1)) ((5 1) (8 0)) ((6 0) (5 0))
    ((6 4) (4 0)) ((7 1) (1 2)) ((8 1) (7 0)))
  (uniq-orig k n nb)
  (gen-st (dev-key-state d o k) (door-state d (opened b nb n)))
...
(defskeleton subatomic-open-closed
  ...
  (facts (same-dev ls lk))
  (leads-to ((2 3) (1 1)) ((5 4) (3 0)) ((5 4) (6 0)) ((7 3) (1 0))
    ((7 3) (2 2)))
  (rule fact-dev-pass-same-dev0 trRl_dev-open-at-1 trRl_dev-open-at-3
    trRl_dev-up-at-1 trRl_dev-up-at-2 trRl_dev-up-at-3 trRl_dev-up-at-4
    trRl_passer-recv-key-at-3 trRl_passer-recv-key-at-4)
...
(defskeleton subatomic-open-closed
  ...
  (deflistener k)
  (precedes ((0 0) (2 0)) ((0 0) (8 0)) ((2 4) (3 1)) ((3 3) (1 0))
    ((4 1) (3 0)) ((5 1) (6 1)) ((6 0) (5 0)) ((6 4) (4 0))
