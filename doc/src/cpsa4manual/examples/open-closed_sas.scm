    ...
    (implies
      ...
      (exists
        ...
        (and (= d-0 d) (= o-0 o) (p "dev-open" z-1 5)
          ...
          (gen-st (dev-key-state d o k))
          (gen-st (door-state d (opened b nb n))) (leads-to z-1 4 z-0 1)
          (leads-to z-4 4 z-2 0) (leads-to z-4 4 z-5 0)
          (leads-to z-6 3 z-0 0) (leads-to z-6 3 z-1 0)
          (leads-to z-6 3 z-1 3) (auth to-b) (auth from-b)
          (auth start-ch) (conf to-b) (fact same-dev ls lk))))))
