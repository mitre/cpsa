...
(comment "CPSA 4.4.0")
(comment "All input read from commitment_sas.scm")
...
(defskeleton commit
  ...
  (maps
    ((0)
      ((sealed (hash a b n quote)) (n n) (quote quote) (outcome outcome)
        (a a) (b b))))
  (origs))
...
(defskeleton commit
  ...
  (shape)
  (satisfies yes)
  (maps ((0) ((sealed (hash a b-0 n quote)) (a a) (b b))))
  (origs))
...
(defskeleton commit
  ...
  (shape)
  (satisfies yes)
  (maps ((0) ((sealed (hash n trash)) (a a) (b b))))
  (origs))
...
(defskeleton commit
  ...
  (traces ((send (enc "bid" (hash a b n quote) (privk "sig" a))))
    ((recv (enc "bid" (hash a b n quote) (privk "sig" a)))
      (send (enc "receipt" (hash a b n quote) (privk "sig" b)))
      (recv (cat n quote))
      (send (enc "result" a b n quote outcome (privk "sig" b)))))
...
(defskeleton commit
  ...
  (non-orig (privk "sig" a))
  (uniq-gen n)
  (operation nonce-test (displaced 0 2 bidder 3) n (1 2))
  (traces
    ((recv (enc "bid" (hash a b n quote) (privk "sig" a)))
      (send (enc "receipt" (hash a b n quote) (privk "sig" b)))
      (recv (cat n quote))
  ...
  (shape)
  (satisfies yes)
  (maps ((1 0) ((n n) (quote quote) (outcome outcome) (a a) (b b))))
  (origs))
