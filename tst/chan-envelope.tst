...
(comment "CPSA 4.2.0")
(comment "All input read from chan-envelope.scm")
...
(defskeleton envelope
  ...
  (conf c)
  (auth c)
  (operation nonce-test (added-strand tpm-extend 3)
...
(defskeleton envelope
  ...
  (conf c)
  (auth c)
  (operation nonce-test (added-strand tpm-extend-enc 3)
    (ch-msg c (hash (hash "0" n) "obtain")) (3 2))
  (traces ((recv v) (send v))
    ((send (enc "extend" n esk))
      (send (enc "create key" (hash (hash "0" n) "obtain") esk))
...
(defskeleton envelope
  ...
  (conf c)
  (auth c)
  (operation nonce-test (added-strand tpm-power-on 2) (ch-msg c "0")
    (5 1))
  (traces ((recv v) (send v))
    ((send (enc "extend" n esk))
      (send (enc "create key" (hash (hash "0" n) "obtain") esk))
...
(defskeleton envelope
  ...
  (conf c)
  (auth c)
  (operation nonce-test (displaced 10 6 tpm-extend-enc 3)
    (ch-msg c-0 (hash "0" n)) (9 1))
  (traces
    ((recv (enc "quote" (hash (hash "0" n) "refuse") (enc v k) aik))
      (send (enc "quote" (hash (hash "0" n) "refuse") (enc v k) aik)))
...
(defskeleton envelope
  ...
  (conf c)
  (auth c)
  (operation nonce-test (displaced 11 7 tpm-power-on 2) (ch-msg c-0 "0")
    (10 1))
  (traces
    ((recv (enc "quote" (hash (hash "0" n) "refuse") (enc v k) aik))
      (send (enc "quote" (hash (hash "0" n) "refuse") (enc v k) aik)))
...
(defskeleton envelope
  ...
  (conf c c-0)
  (auth c c-0)
  (operation nonce-test (added-strand tpm-power-on 2) (ch-msg c-0 "0")
    (10 1))
  (traces
    ((recv (enc "quote" (hash (hash "0" n) "refuse") (enc v k) aik))
      (send (enc "quote" (hash (hash "0" n) "refuse") (enc v k) aik)))
