  ...
  (defgenrule cau-dev-pass-2
    (forall ((i indx) (z1 z strd))
      (implies (and (p "dev-pass" z (idx 3)) (prec z1 i z (idx 2)))
        (or (= z z1) (prec z1 i z (idx 1))))))
  (defgenrule eff-dev-pass-3
    (forall ((i indx) (z1 z strd))
      (implies (and (p "dev-pass" z (idx 4)) (prec z (idx 3) z1 i))
        (or (= z z1)
          (and (p "dev-pass" z (idx 3)) (prec z (idx 2) z1 i)))))))
...
(defskeleton atomic-open-closed
  ...
  (rule cau-dev-pass-2 dev-open-atomic1 discreteBefore gen-state-open
    intro-same-dev-open same-dev-ls-lk trRl_dev-open-at-2
    trRl_dev-open-at-3)
...
(defskeleton atomic-open-closed
  ...
  (defstrand dev-up 5 (old old) (old1 old1) (k k) (d d) (o o)
    (start-ch start-ch) (lk lk) (ls ls))
  (precedes ((1 0) (3 0)) ((2 3) (0 1)) ((3 4) (2 1)))
  (uniq-orig n)
  (gen-st (cat "st" d o o) (cat "st-k" d o k))
  (conf start-ch)
  (auth start-ch)
  (facts (same-dev ls lk))
  (leads-to ((2 3) (0 2)) ((3 2) (0 1)) ((3 2) (2 1)))
  (rule atomic-up-pass dev-up-completes discreteBefore intro-same-dev-up
  ...
  (origs (pt-2 (3 2)) (pt-4 (3 4)) (pt (2 3)) (n (0 3))))
...
(defskeleton atomic-open-closed
  ...
  (defstrand dev-up 5 (old old) (old1 old1) (k k) (d d) (o o)
    (start-ch start-ch) (lk lk) (ls ls))
  (precedes ((0 0) (4 0)) ((2 0) (1 0)) ((3 3) (1 1)) ((4 4) (3 1)))
  (uniq-orig k n)
  (gen-st (cat "st" d o o) (cat "st-k" d o k))
  (conf start-ch)
  (auth start-ch)
  (facts (same-dev ls lk))
  (leads-to ((3 3) (1 2)) ((4 2) (1 1)) ((4 2) (3 1)))
  (rule atomic-up-pass dev-up-completes discreteBefore intro-same-dev-up
    same-dev-lk-ls trRl_dev-up-at-1 trRl_dev-up-at-2 trRl_dev-up-at-3
    trRl_dev-up-at-4)
  (operation channel-test (added-strand dev-up 3)
...
(defskeleton atomic-open-closed
  ...
  (defstrand dev-up 5 (old old) (old1 old1) (k k) (d d) (o o)
    (start-ch start-ch) (lk lk) (ls ls))
  (deflistener k)
  (precedes ((0 0) (4 0)) ((0 0) (5 0)) ((2 0) (1 0)) ((3 3) (1 1))
    ((4 4) (3 1)) ((5 1) (3 0)))
  (uniq-orig k n)
  (gen-st (cat "st" d o o) (cat "st-k" d o k))
  (conf start-ch)
...
(defskeleton atomic-open-closed
  ...
  (rule intro-same-dev-up power-deliver-once trRl_dev-up-at-1
...
(defskeleton atomic-open-closed
  ...
  (defstrand owner-open 1 (k k) (n n-0) (d d) (o o))
  (deflistener k)
  (precedes ((0 0) (4 0)) ((0 0) (6 0)) ((2 0) (1 0)) ((3 3) (1 1))
    ((4 4) (3 1)) ((5 0) (3 0)) ((6 1) (0 1)))
  (uniq-orig k n)
  (gen-st (cat "st" d o o) (cat "st-k" d o k))
  (conf start-ch)
  (auth start-ch)
...
(defskeleton atomic-open-closed
  ...
  (defstrand dev-up 5 (old old) (old1 old1) (k k) (d d) (o o)
    (start-ch start-ch) (lk lk) (ls ls))
  (precedes ((0 0) (5 0)) ((2 0) (1 0)) ((3 3) (1 1)) ((4 1) (3 0))
    ((5 4) (4 0)))
  (uniq-orig k n)
  (gen-st (cat "st" d o o) (cat "st-k" d o k))
  (conf start-ch)
  ...
  (leads-to ((3 3) (1 2)) ((5 2) (1 1)) ((5 2) (3 1)))
  (rule dev-up-atomic2 dev-up-completes intro-same-dev-up
    power-deliver-once trRl_dev-up-at-1 trRl_dev-up-at-2)
...
(defskeleton atomic-open-closed
  ...
  (defstrand dev-up 5 (old old) (old1 old1) (k k) (d d) (o o)
    (start-ch start-ch) (lk lk) (ls ls))
  (precedes ((0 0) (6 0)) ((2 0) (1 0)) ((3 3) (1 1)) ((4 0) (3 0))
    ((5 1) (0 1)) ((6 4) (3 1)) ((6 4) (5 0)))
  (uniq-orig k n)
  (gen-st (cat "st" d o o) (cat "st-k" d o k))
  (conf start-ch)
  (auth start-ch)
  (facts (same-dev ls lk))
  (leads-to ((3 3) (1 2)) ((6 2) (1 1)) ((6 2) (3 1)))
  (rule dev-up-atomic2 dev-up-completes intro-same-dev-up
    power-deliver-once trRl_dev-up-at-1 trRl_dev-up-at-2)
  (operation nonce-test (added-strand dev-up 3) k (6 0)
    (ch-msg start-ch (cat "power-up" d o k)))
  (strand-map 0 1 2 3 5 6 4)
  (traces ((send start-ch (cat "power-up" d o k)) (recv (enc "up" k)))
    ((recv (enc "may I pass" k)) (load lk (cat pt-2 "st-k" d o k))
      (load ls (cat pt "st" d o o)) (send (enc "you may pass" n k)))
    ((send (enc "may I pass" k)))
