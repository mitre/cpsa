...
(defskeleton open-closed
  (vars (any mesg) (n n-0 text) (d o o-0 name) (k k-0 skey)
    (lk ls lk-0 locn))
  (defstrand dev-pass 4 (n n) (d d) (o o) (k k) (lk lk) (ls ls))
...
(defskeleton open-closed
  (vars (old any mesg) (n n-0 text) (d o o-0 name) (k k-0 skey)
...
(defskeleton open-closed
  (vars (any old old1 mesg) (n n-0 text) (o d o-0 name) (k k-0 skey)
