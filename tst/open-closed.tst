...
(defskeleton open-closed
  ...
  (facts (ha 2 1 2 1) (ha 2 1 2 2) (ha 2 2 2 1) (ha 2 2 2 2) (trans 2 2)
    (trans 2 1))
  (rule same-locn trRl_dev-up-at-2 trRl_dev-up-at-1)
...
(defskeleton open-closed
  ...
  (auth start-ch)
  (facts (ha 2 1 2 1) (ha 2 1 2 2) (ha 2 2 2 1) (ha 2 2 2 2) (trans 2 2)
    (trans 2 1) (ha 1 0 1 0) (ha 1 2 1 2))
  (rule same-locn trRl_dev-up-at-2 trRl_dev-up-at-1)
  (operation nonce-test (added-strand dev-up 3) k (1 0)
    (ch-msg start-ch (cat "power-up" d o k)))
  (traces ((send start-ch (cat "power-up" d o k)) (recv (enc "up" k)))
...
(defskeleton open-closed
  ...
  (facts (ha 1 0 2 1) (ha 1 0 2 2) (ha 2 1 1 0) (ha 2 2 1 0)
    ...
    (trans 2 2) (trans 2 1) (ha 1 0 1 0) (ha 1 2 1 2))
...
(defskeleton open-closed
  ...
  (facts (ha 1 2 4 2) (ha 1 2 4 3) (ha 4 0 4 0) (ha 4 2 1 2)
    ...
    (la 4 3 1 2) (trans 4 3) (trans 4 2) (ha 1 0 2 1) (ha 1 0 2 2)
    (ha 2 1 1 0) (ha 2 2 1 0) (la 2 2 1 0) (ha 2 1 2 1) (ha 2 1 2 2)
    (ha 2 2 2 1) (ha 2 2 2 2) (trans 2 2) (trans 2 1) (ha 1 0 1 0)
    (ha 1 2 1 2))
  (rule same-locn leadsto-la trRl_dev-open-at-3 trRl_dev-open-at-2)
  (operation channel-test (added-strand dev-open 4)
