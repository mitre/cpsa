...
(defprotocol subatomic-open-closed basic
  ...
  (defgenrule st-sg-dev-up-3
    (forall ((z strd))
      (implies (p "dev-up" z (idx 4))
        (fact st-sg-str z (idx 1) (idx 3)))))
  (defgenrule st-sg-dev-up-4
    (forall ((z strd))
      (implies (p "dev-up" z (idx 5))
        (fact st-sg-str z (idx 1) (idx 4)))))
  ...
  (defgenrule st-sg-dev-close-3
    (forall ((z strd))
      (implies (p "dev-close" z (idx 4))
        (fact st-sg-str z (idx 1) (idx 3)))))
  (defgenrule st-sg-dev-pass-1
    (forall ((z strd))
      (implies (p "dev-pass" z (idx 2))
        (fact st-sg-str z (idx 0) (idx 1)))))
...
(defskeleton subatomic-open-closed
  (vars (old old1 mesg) (k skey) (d o name) (pt pt-0 pt-1 pval)
    (start-ch chan) (lk ls locn))
  (defstrand owner-power-dev 2 (k k) (d d) (o o) (start-ch start-ch))
  (deflistener k)
  (defstrand dev-up 4 (old old) (old1 old1) (k k) (d d) (o o)
    (start-ch start-ch) (lk lk) (ls ls))
  (precedes ((0 0) (2 0)) ((2 3) (1 0)))
  (uniq-orig k)
  (conf start-ch)
  (auth start-ch)
  (facts (same-dev ls lk) (st-sg-str 2 (idx 1) (idx 2))
    (st-sg-str 2 (idx 1) (idx 3)) (no-state-split))
  (rule fact-dev-up-same-dev0 st-sg-dev-up-2 st-sg-dev-up-3
...
(defskeleton subatomic-open-closed
  ...
  (facts (same-dev ls lk) (st-sg-str 0 (idx 0) (idx 1))
    (no-state-split))
...
(defskeleton subatomic-open-closed
  (vars (old old1 mesg) (k skey) (n text) (d o name)
    (pt pt-0 pt-1 pt-2 pval) (start-ch chan) (lk ls locn))
  (defstrand dev-pass 4 (k k) (n n) (d d) (o o) (lk lk) (ls ls))
  (defstrand dev-up 4 (old old) (old1 old1) (k k) (d d) (o o)
    (start-ch start-ch) (lk lk) (ls ls))
  (precedes ((1 3) (0 0)))
  ...
  (facts (same-dev ls lk) (st-sg-str 1 (idx 1) (idx 2))
    (st-sg-str 1 (idx 1) (idx 3)) (st-sg-str 0 (idx 0) (idx 1))
    (no-state-split))
  (leads-to ((1 3) (0 0)))
  (rule fact-dev-up-same-dev0 same-dev-lk-ls st-sg-dev-up-2
    st-sg-dev-up-3 trRl_dev-up-at-1 trRl_dev-up-at-3)
  (operation channel-test (added-strand dev-up 4)
    (ch-msg lk (cat pt "st-k" d o k)) (0 0))
  (strand-map 0)
  (traces
    ((load lk (cat pt "st-k" d o k)) (load ls (cat pt-0 "st" d o o))
      (recv (enc "may I pass" k)) (send (enc "you may pass" n k)))
    ((recv start-ch (cat "power-up" d o k)) (load lk (cat pt-1 old))
      (load ls (cat pt-2 old1)) (stor lk (cat pt "st-k" d o k))))
  (label 5)
  (parent 4)
  (unrealized (0 1) (1 0))
  (comment "1 in cohort - 1 not yet seen"))
...
(defskeleton subatomic-open-closed
  ...
  (defstrand dev-open 4 (any any) (k k-0) (n n-0) (d d) (o o) (lk lk)
    (ls ls))
  (precedes ((1 3) (0 0)) ((2 0) (1 0)) ((3 3) (0 0)))
  (uniq-orig n)
  (gen-st (cat "st" d o o) (cat "st-k" d o k) (cat "st-k" d o k-0))
  (conf start-ch)
  (auth start-ch)
  (facts (same-dev ls lk) (st-sg-str 3 (idx 1) (idx 2))
    (st-sg-str 3 (idx 1) (idx 3)) (st-sg-str 1 (idx 1) (idx 2))
    (st-sg-str 1 (idx 1) (idx 3)) (st-sg-str 0 (idx 0) (idx 1))
    (no-state-split))
  (leads-to ((1 3) (0 0)) ((3 3) (0 1)))
  (rule causeRule fact-dev-open-same-dev0 gen-st-dev-open-1
    same-dev-ls-lk st-sg-dev-open-2 st-sg-dev-open-3 trRl_dev-open-at-1
    trRl_dev-open-at-3)
  (operation channel-test (added-strand dev-open 4)
    (ch-msg ls (cat pt-0 "st" d o o)) (0 1))
  (strand-map 0 1 2)
  (traces
    ((load lk (cat pt "st-k" d o k)) (load ls (cat pt-0 "st" d o o))
      (recv (enc "may I pass" k)) (send (enc "you may pass" n k)))
  ...
  (seen-ops
    (8
      (operation channel-test (added-strand dev-up 4)
        (ch-msg lk (cat pt "st-k" d o k)) (3 2)) (strand-map 0 1 2 3)))
  (unrealized (3 2))
  (comment "3 in cohort - 2 not yet seen"))

(defskeleton subatomic-open-closed
  (vars (old old1 any mesg) (k skey) (n n-0 text) (d o name)
    (pt pt-0 pt-1 pt-2 pt-3 pval) (start-ch chan) (ls lk locn))
  (defstrand dev-pass 4 (k k) (n n) (d d) (o o) (lk lk) (ls ls))
  (defstrand dev-up 4 (old old) (old1 old1) (k k) (d d) (o o)
    (start-ch start-ch) (lk lk) (ls ls))
  (defstrand owner-power-dev 1 (k k) (d d) (o o) (start-ch start-ch))
  (defstrand dev-open 4 (any any) (k k) (n n-0) (d d) (o o) (lk lk)
    (ls ls))
  (precedes ((1 3) (3 1)) ((2 0) (1 0)) ((3 3) (0 0)))
  (uniq-orig n)
  (gen-st (cat "st" d o o) (cat "st-k" d o k))
  (conf start-ch)
  (auth start-ch)
  ...
  (operation channel-test (displaced 4 1 dev-up 4)
    (ch-msg lk (cat pt-4 "st-k" d o k-0)) (3 2))
  (strand-map 0 1 2 3)
  (traces
    ((load lk (cat pt "st-k" d o k)) (load ls (cat pt-0 "st" d o o))
      (recv (enc "may I pass" k)) (send (enc "you may pass" n k)))
    ((recv start-ch (cat "power-up" d o k)) (load lk (cat pt-1 old))
      (load ls (cat pt-2 old1)) (stor lk (cat pt "st-k" d o k)))
    ((send start-ch (cat "power-up" d o k)))
    ((recv (enc "open" d o n-0 k)) (load ls (cat pt-3 "st" d any))
      (load lk (cat pt "st-k" d o k)) (stor ls (cat pt-0 "st" d o o))))
  (label 8)
  (parent 7)
  (realized)
  (shape)
  (maps ((0) ((k k) (n n) (d d) (o o) (lk lk) (ls ls))))
  (origs (pt (1 3)) (pt-0 (3 3)) (n (0 3))))

(defskeleton subatomic-open-closed
  (vars (old old1 any old-0 old1-0 mesg) (k k-0 skey) (n n-0 text)
    (d o name) (pt pt-0 pt-1 pt-2 pt-3 pt-4 pt-5 pt-6 pval)
  ...
  (defstrand dev-open 4 (any any) (k k-0) (n n-0) (d d) (o o) (lk lk)
    (ls ls))
  (defstrand dev-up 4 (old old-0) (old1 old1-0) (k k-0) (d d) (o o)
    (start-ch start-ch-0) (lk lk) (ls ls))
  (precedes ((1 3) (0 0)) ((2 0) (1 0)) ((3 3) (0 0)) ((4 3) (1 1))
    ((4 3) (3 1)))
  (uniq-orig n)
  (gen-st (cat "st" d o o) (cat "st-k" d o k) (cat "st-k" d o k-0))
  (conf start-ch)
  ...
  (facts (same-dev ls lk) (st-sg-str 4 (idx 1) (idx 2))
    (st-sg-str 4 (idx 1) (idx 3)) (st-sg-str 3 (idx 1) (idx 2))
    (st-sg-str 3 (idx 1) (idx 3)) (st-sg-str 1 (idx 1) (idx 2))
    (st-sg-str 1 (idx 1) (idx 3)) (st-sg-str 0 (idx 0) (idx 1))
    (no-state-split))
  (leads-to ((1 3) (0 0)) ((3 3) (0 1)) ((4 3) (3 2)))
  (rule causeRule discreteBefore fact-dev-up-same-dev0 same-dev-lk-ls
    st-sg-dev-up-2 st-sg-dev-up-3 trRl_dev-up-at-1 trRl_dev-up-at-3)
  (operation channel-test (added-strand dev-up 4)
    (ch-msg lk (cat pt-4 "st-k" d o k-0)) (3 2))
  (strand-map 0 1 2 3)
  (traces
...
(defskeleton subatomic-open-closed
  ...
  (defstrand dev-up 4 (old old-0) (old1 old1-0) (k k-0) (d d) (o o)
    (start-ch start-ch-0) (lk lk) (ls ls))
  (defstrand owner-power-dev 1 (k k-0) (d d) (o o)
    (start-ch start-ch-0))
  (precedes ((1 3) (0 0)) ((2 0) (1 0)) ((3 3) (0 0)) ((4 3) (1 1))
    ((4 3) (3 1)) ((5 0) (4 0)))
  (uniq-orig n)
  ...
  (shape)
  (maps ((0) ((k k) (n n) (d d) (o o) (lk lk) (ls ls))))
  (origs (pt-4 (4 3)) (pt-0 (3 3)) (pt (1 3)) (n (0 3))))
...
(defskeleton subatomic-open-closed
  ...
  (conf start-ch)
  (facts (same-dev ls lk) (st-sg-str 1 (idx 0) (idx 1))
    (no-state-split))
  (rule fact-dev-pass-same-dev0 gen-st-dev-pass-0 gen-st-dev-pass-1
    st-sg-dev-pass-1)
  (traces ((send start-ch (cat "power-up" d o k)) (recv (enc "up" k)))
...
(defskeleton subatomic-open-closed
  ...
  (defstrand owner-power-dev 2 (k k) (d d) (o o) (start-ch start-ch))
  (defstrand dev-pass 4 (k k) (n n) (d d-0) (o o-0) (lk lk) (ls ls))
  (defstrand dev-up 4 (old old) (old1 old1) (k k) (d d-0) (o o-0)
    (start-ch start-ch-0) (lk lk) (ls ls))
  (precedes ((0 0) (2 0)) ((2 3) (1 0)))
  (uniq-orig k n)
  (gen-st (cat "st" d-0 o-0 o-0) (cat "st-k" d-0 o-0 k))
  ...
  (auth start-ch-0)
  (facts (same-dev ls lk) (st-sg-str 2 (idx 1) (idx 2))
    (st-sg-str 2 (idx 1) (idx 3)) (st-sg-str 1 (idx 0) (idx 1))
    (no-state-split))
  (leads-to ((2 3) (1 0)))
  (rule fact-dev-up-same-dev0 same-dev-lk-ls st-sg-dev-up-2
    st-sg-dev-up-3 trRl_dev-up-at-1 trRl_dev-up-at-3)
  (operation channel-test (added-strand dev-up 4)
    (ch-msg lk (cat pt "st-k" d-0 o-0 k)) (1 0))
  (strand-map 0 1)
  (traces ((send start-ch (cat "power-up" d o k)) (recv (enc "up" k)))
    ((load lk (cat pt "st-k" d-0 o-0 k))
      (load ls (cat pt-0 "st" d-0 o-0 o-0)) (recv (enc "may I pass" k))
    ...
    ((recv start-ch-0 (cat "power-up" d-0 o-0 k))
      (load lk (cat pt-1 old)) (load ls (cat pt-2 old1))
      (stor lk (cat pt "st-k" d-0 o-0 k))))
  (label 14)
  (parent 13)
...
(defskeleton subatomic-open-closed
  ...
  (defstrand dev-open 4 (any any) (k k-0) (n n-0) (d d) (o o) (lk lk)
    (ls ls))
  (precedes ((0 0) (2 0)) ((2 3) (1 0)) ((3 3) (1 0)))
  (uniq-orig k n)
  (gen-st (cat "st" d o o) (cat "st-k" d o k) (cat "st-k" d o k-0))
  (conf start-ch)
  (auth start-ch)
  (facts (same-dev ls lk) (st-sg-str 3 (idx 1) (idx 2))
    (st-sg-str 3 (idx 1) (idx 3)) (st-sg-str 2 (idx 1) (idx 2))
    (st-sg-str 2 (idx 1) (idx 3)) (st-sg-str 1 (idx 0) (idx 1))
    (no-state-split))
  ...
  (rule causeRule fact-dev-open-same-dev0 gen-st-dev-open-1
    ...
    trRl_dev-open-at-3)
  (operation channel-test (added-strand dev-open 4)
    (ch-msg ls (cat pt-0 "st" d o o)) (1 1))
  (strand-map 0 1 2)
  (traces ((send start-ch (cat "power-up" d o k)) (recv (enc "up" k)))
    ((load lk (cat pt "st-k" d o k)) (load ls (cat pt-0 "st" d o o))
      (recv (enc "may I pass" k)) (send (enc "you may pass" n k)))
...
(defskeleton subatomic-open-closed
  ...
  (defstrand dev-open 4 (any any) (k k) (n n-0) (d d) (o o) (lk lk)
    (ls ls))
  (precedes ((0 0) (2 0)) ((2 3) (3 1)) ((3 3) (1 0)))
  (uniq-orig k n)
  (gen-st (cat "st" d o o) (cat "st-k" d o k))
  (conf start-ch)
  (auth start-ch)
...
(defskeleton subatomic-open-closed
  ...
  (defstrand dev-up 4 (old old-0) (old1 old1-0) (k k-0) (d d) (o o)
    (start-ch start-ch-0) (lk lk) (ls ls))
  (precedes ((0 0) (2 0)) ((2 3) (1 0)) ((3 3) (1 0)) ((4 3) (2 1))
    ((4 3) (3 1)))
  (uniq-orig k n)
  (gen-st (cat "st" d o o) (cat "st-k" d o k) (cat "st-k" d o k-0))
  (conf start-ch)
  ...
  (facts (same-dev ls lk) (st-sg-str 4 (idx 1) (idx 2))
    ...
    (st-sg-str 2 (idx 1) (idx 3)) (st-sg-str 1 (idx 0) (idx 1))
    (no-state-split))
  (leads-to ((2 3) (1 0)) ((3 3) (1 1)) ((4 3) (3 2)))
  (rule causeRule discreteBefore fact-dev-up-same-dev0 same-dev-lk-ls
    st-sg-dev-up-2 st-sg-dev-up-3 trRl_dev-up-at-1 trRl_dev-up-at-3)
  (operation channel-test (added-strand dev-up 4)
    (ch-msg lk (cat pt-4 "st-k" d o k-0)) (3 2))
...
(defskeleton subatomic-open-closed
  ...
  (precedes ((0 0) (2 0)) ((2 3) (3 1)) ((3 3) (1 0)) ((4 0) (3 0)))
  (uniq-orig k n)
  (gen-st (cat "st" d o o) (cat "st-k" d o k))
  (conf start-ch)
  (auth start-ch)
...
(defskeleton subatomic-open-closed
  ...
  (defstrand dev-open 4 (any any) (k k) (n n-0) (d d) (o o) (lk lk)
    (ls ls))
  (deflistener k)
  (precedes ((0 0) (2 0)) ((0 0) (4 0)) ((2 3) (3 1)) ((3 3) (1 0))
    ((4 1) (3 0)))
  (uniq-orig k n)
  (gen-st (cat "st" d o o) (cat "st-k" d o k))
  (conf start-ch)
...
(defskeleton subatomic-open-closed
  ...
  (defstrand owner-open 1 (k k) (n n-0) (d d) (o o))
  (deflistener k)
  (precedes ((0 0) (2 0)) ((0 0) (5 0)) ((2 3) (3 1)) ((3 3) (1 0))
    ((4 0) (3 0)) ((5 1) (1 2)))
  (uniq-orig k n)
  (gen-st (cat "st" d o o) (cat "st-k" d o k))
  (conf start-ch)
...
(defskeleton subatomic-open-closed
  ...
  (defstrand dev-open 4 (any any) (k k) (n n-0) (d d) (o o) (lk lk)
    (ls ls))
  (deflistener k)
  (precedes ((0 0) (2 0)) ((2 3) (4 0)) ((3 3) (1 0)) ((4 1) (3 0)))
  (uniq-orig k n)
  (gen-st (cat "st" d o o) (cat "st-k" d o k))
  (conf start-ch)
  (auth start-ch)
...
(defskeleton subatomic-open-closed
  ...
  (defstrand owner-power-dev 1 (k k-0) (d d) (o o)
    (start-ch start-ch-0))
  (deflistener k)
  (precedes ((0 0) (2 0)) ((0 0) (6 0)) ((2 3) (1 0)) ((3 3) (1 0))
    ((4 3) (2 1)) ((4 3) (3 1)) ((5 0) (4 0)) ((6 1) (1 2)))
  (uniq-orig k n)
  (gen-st (cat "st" d o o) (cat "st-k" d o k) (cat "st-k" d o k-0))
  (conf start-ch start-ch-0)
  (auth start-ch start-ch-0)
...
(defskeleton subatomic-open-closed
  ...
  (conf start-ch)
  (auth start-ch)
  (facts (st-sg-str 5 (idx 1) (idx 4)) (same-dev ls lk)
    (st-sg-str 2 (idx 1) (idx 2)) (st-sg-str 2 (idx 1) (idx 3))
    (st-sg-str 5 (idx 1) (idx 2)) (st-sg-str 5 (idx 1) (idx 3))
    (st-sg-str 1 (idx 0) (idx 1)) (no-state-split))
  (leads-to ((2 3) (1 1)) ((5 3) (1 0)) ((5 3) (2 2)))
  (rule effectRule st-sg-dev-up-4 trRl_dev-up-at-2 trRl_dev-up-at-4)
...
(defskeleton subatomic-open-closed
  ...
  (defstrand user-pass 1 (k k))
  (deflistener k)
  (precedes ((0 0) (2 0)) ((0 0) (6 0)) ((2 3) (3 1)) ((3 3) (1 0))
...
(defskeleton subatomic-open-closed
  ...
  (defstrand owner-open 1 (k k) (n n-0) (d d) (o o))
  (deflistener k)
  (precedes ((0 0) (2 0)) ((2 3) (3 1)) ((2 3) (5 0)) ((3 3) (1 0))
    ((4 0) (3 0)) ((5 1) (1 2)))
  (uniq-orig k n)
  (gen-st (cat "st" d o o) (cat "st-k" d o k))
  (conf start-ch)
...
(defskeleton subatomic-open-closed
  ...
  (defstrand user-pass 1 (k k))
  (deflistener k)
  (precedes ((0 0) (2 0)) ((0 0) (7 0)) ((2 3) (1 0)) ((3 3) (1 0))
    ((4 3) (2 1)) ((4 3) (3 1)) ((5 0) (4 0)) ((6 0) (1 2))
    ((7 1) (0 1)))
  (uniq-orig k n)
  (gen-st (cat "st" d o o) (cat "st-k" d o k) (cat "st-k" d o k-0))
  (conf start-ch start-ch-0)
  ...
  (seen-ops
    (33
      (operation nonce-test (added-strand dev-up 4) k (7 0)
        (ch-msg start-ch (cat "power-up" d o k)))
      (strand-map 0 1 3 4 5 6 7 2)))
  (unrealized (7 0))
  (comment "2 in cohort - 1 not yet seen"))
...
(defskeleton subatomic-open-closed
  ...
  (defstrand owner-power-dev 1 (k k-0) (d d) (o o)
    (start-ch start-ch-0))
  (deflistener k)
  (precedes ((0 0) (2 0)) ((2 3) (1 0)) ((2 3) (6 0)) ((3 3) (1 0))
    ((4 3) (2 1)) ((4 3) (3 1)) ((5 0) (4 0)) ((6 1) (1 2)))
  (uniq-orig k n)
  (gen-st (cat "st" d o o) (cat "st-k" d o k) (cat "st-k" d o k-0))
  (conf start-ch start-ch-0)
...
(defskeleton subatomic-open-closed
  ...
  (defstrand user-pass 1 (k k))
  (deflistener k)
  (precedes ((0 0) (2 0)) ((2 3) (3 1)) ((2 3) (6 0)) ((3 3) (1 0))
    ((4 0) (3 0)) ((5 0) (1 2)) ((6 1) (0 1)))
  (uniq-orig k n)
  (gen-st (cat "st" d o o) (cat "st-k" d o k))
  (conf start-ch)
...
(defskeleton subatomic-open-closed
  ...
  (defstrand user-pass 1 (k k))
  (deflistener k)
  (precedes ((0 0) (2 0)) ((2 3) (1 0)) ((2 3) (7 0)) ((3 3) (1 0))
    ((4 3) (2 1)) ((4 3) (3 1)) ((5 0) (4 0)) ((6 0) (1 2))
    ((7 1) (0 1)))
  (uniq-orig k n)
  (gen-st (cat "st" d o o) (cat "st-k" d o k) (cat "st-k" d o k-0))
