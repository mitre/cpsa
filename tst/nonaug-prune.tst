...
(defskeleton nonaug-prune
  ...
  (parent 22)
  (seen 14)
  (seen-opts (14 (operation generalization deleted (3 0))))
  (realized)
  (comment "1 in cohort - 0 not yet seen"))
...
(defskeleton nonaug-prune
  ...
  (parent 24)
  (seen 14)
  (seen-opts (14 (operation generalization weakened ((1 1) (0 0)))))
  (realized)
  (origs (n (2 0)))
  (ugens)
  (comment "1 in cohort - 0 not yet seen"))
...
(defskeleton nonaug-prune
  ...
  (parent 29)
  (seen 32)
  (seen-opts (32 (operation generalization deleted (3 0))))
  (realized)
  (comment "1 in cohort - 0 not yet seen"))
...
(defskeleton nonaug-prune
  ...
  (parent 33)
  (seen 32)
  (seen-opts (32 (operation generalization weakened ((3 1) (0 0)))))
  (realized)
  (comment "1 in cohort - 0 not yet seen"))
...
(defskeleton nonaug-prune
  ...
  (parent 38)
  (seen 32)
  (seen-opts (32 (operation generalization deleted (4 0))))
  (realized)
  (comment "1 in cohort - 0 not yet seen"))
