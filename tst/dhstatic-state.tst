...
(defprotocol dhstatic-state diffie-hellman
  ...
  (defgenrule eff-init-1
    (forall ((i indx) (z1 z strd))
      (implies (and (p "init" z (idx 2)) (prec z (idx 1) z1 i))
        (or (= z z1)
          (and (p "init" z (idx 1)) (prec z (idx 0) z1 i))))))
  (defgenrule eff-resp-1
    (forall ((i indx) (z1 z strd))
      (implies (and (p "resp" z (idx 2)) (prec z (idx 1) z1 i))
        (or (= z z1)
          (and (p "resp" z (idx 1)) (prec z (idx 0) z1 i))))))
