...
(defskeleton dhstatic-state
  ...
  (defstrand get-cert 4 (ignore ignore) (serial serial-a) (self a)
    (ca ca) (static-key static-key) (ra ra))
  (defstrand cert 2 (serial serial-a) (subj a) (ca ca)
    (galpha (exp (gen) ra)))
...
(defskeleton dhstatic-state
  ...
  (defstrand cert 2 (serial serial-a) (subj a) (ca ca)
    (galpha (exp (gen) ra)))
  (defstrand cert 2 (serial serial-b) (subj b) (ca ca) (galpha galpha))
...
(defskeleton dhstatic-state
  ...
  (defstrand cert 2 (serial serial-a) (subj a) (ca ca)
    (galpha (exp (gen) ra)))
  (defstrand cert 2 (serial serial-b) (subj b) (ca ca)
    (galpha (exp (gen) ra-0)))
...
(defskeleton dhstatic-state
  ...
  (defstrand cert 2 (serial serial-a) (subj a) (ca ca)
    (galpha (exp (gen) ra)))
  (defstrand cert 2 (serial serial-b) (subj self) (ca ca)
    (galpha (exp (gen) ra-0)))
  (deflistener (exp (gen) (mul ra ra-0)))
  (deflistener (cat (exp (gen) ra) ra-0))
...
(defskeleton dhstatic-state
  ...
  (defstrand cert 2 (serial serial-a) (subj a) (ca ca-0)
    (galpha (exp (gen) ra)))
  (defstrand cert 2 (serial serial-b) (subj self) (ca ca-0)
    (galpha (exp (gen) ra-1)))
  (defstrand resp 4 (serial-b serial-b) (serial-a serial-a) (n n) (a a)
...
(defskeleton dhstatic-state
  ...
  (defstrand get-cert 4 (ignore ignore-0) (serial serial) (self self)
    (ca ca) (static-key static-key-0) (ra ra-0))
  (defstrand cert 2 (serial serial) (subj self) (ca ca)
    (galpha (exp (gen) ra-0)))
  (precedes ((1 0) (2 0)) ((1 0) (5 0)) ((1 3) (0 0)) ((2 1) (1 1))
    ((3 1) (0 1)) ((4 1) (0 3)) ((5 1) (4 0)) ((6 0) (3 0))
...
(defskeleton dhstatic-state
  ...
  (defstrand get-cert 4 (ignore ignore-1) (serial serial) (self self)
    (ca ca-0) (static-key static-key-1) (ra ra-1))
  (defstrand cert 2 (serial serial) (subj self) (ca ca-0)
    (galpha (exp (gen) ra-1)))
  (precedes ((0 2) (4 2)) ((1 0) (2 0)) ((1 0) (6 0)) ((1 3) (0 0))
    ((2 1) (1 1)) ((2 1) (4 1)) ((3 1) (0 1)) ((3 1) (5 1))
    ((4 3) (0 3)) ((5 0) (6 0)) ((5 3) (4 0)) ((6 1) (4 1))
...
(defskeleton dhstatic-state
  ...
  (defstrand cert 2 (serial serial-b) (subj b) (ca ca)
    (galpha (exp (gen) ra)))
  (defstrand cert 2 (serial serial-a) (subj a) (ca ca) (galpha galpha))
  (precedes ((1 0) (2 0)) ((1 3) (0 0)) ((2 1) (1 1)) ((3 1) (0 1)))
  (non-orig (privk "sig" ca) (privk "sig" a))
...
(defskeleton dhstatic-state
  ...
  (defstrand cert 2 (serial serial-b) (subj b) (ca ca)
    (galpha (exp (gen) ra)))
  (defstrand cert 2 (serial serial-a) (subj self) (ca ca)
    (galpha (exp (gen) ra-0)))
  (deflistener (exp (gen) (mul ra ra-0)))
  (deflistener (cat (exp (gen) ra) ra-0))
  (defstrand get-cert 4 (ignore ignore-0) (serial serial) (self self)
...
(defskeleton dhstatic-state
  ...
  (defstrand get-cert 4 (ignore ignore) (serial serial-b) (self b)
    (ca ca-0) (static-key static-key) (ra ra))
  (defstrand cert 2 (serial serial-b) (subj b) (ca ca-0)
    (galpha (exp (gen) ra)))
  (defstrand cert 2 (serial serial-a) (subj self) (ca ca-0)
    (galpha (exp (gen) ra-1)))
