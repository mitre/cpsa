...
(defprotocol dhstatic-state diffie-hellman
  ...
  (defgenrule st-sg-get-cert-3
    (forall ((z strd))
      (implies (p "get-cert" z (idx 4))
...
(defskeleton dhstatic-state
  ...
  (uniq-gen ra)
  (gen-st (cat "privkey" a ra serial-a ca))
  (facts (st-sg-str 1 (idx 2) (idx 3)) (neq a b) (neq b a))
  (leads-to ((1 3) (0 0)))
  (rule st-sg-get-cert-3 trRl_get-cert-at-2 trRl_get-cert-at-3)
...
(defskeleton dhstatic-state
  ...
  (gen-st (cat "privkey" b ra-0 serial-b ca)
    (cat "privkey" a ra serial-a ca))
  (facts (st-sg-str 5 (idx 2) (idx 3)) (st-sg-str 1 (idx 2) (idx 3))
    (neq a b) (neq b a))
...
(defskeleton dhstatic-state
  ...
  (gen-st (cat "privkey" b ra-1 serial-b ca-0)
    (cat "privkey" a ra serial-a ca))
  (facts (st-sg-str 6 (idx 2) (idx 3)) (st-sg-str 1 (idx 2) (idx 3))
    (neq a b) (neq b a))
...
(defskeleton dhstatic-state
  ...
  (facts (st-sg-str 7 (idx 2) (idx 3)) (st-sg-str 5 (idx 2) (idx 3))
    (st-sg-str 1 (idx 2) (idx 3)) (neq a self) (neq self a))
  (leads-to ((1 3) (0 0)) ((5 3) (4 0)))
  (rule st-sg-get-cert-3 trRl_get-cert-at-2 trRl_get-cert-at-3)
...
(defskeleton dhstatic-state
  ...
  (facts (st-sg-str 1 (idx 2) (idx 3)) (neq b a) (neq a b))
  (leads-to ((1 3) (0 0)))
  (rule st-sg-get-cert-3 trRl_get-cert-at-2 trRl_get-cert-at-3)
  (operation channel-test (added-strand get-cert 4)
...
(defskeleton dhstatic-state
  ...
  (facts (st-sg-str 7 (idx 2) (idx 3)) (st-sg-str 5 (idx 2) (idx 3))
    (st-sg-str 1 (idx 2) (idx 3)) (neq b self) (neq self b))
  (leads-to ((1 3) (0 0)) ((5 3) (4 0)))
  (rule st-sg-get-cert-3 trRl_get-cert-at-2 trRl_get-cert-at-3)
  (operation nonce-test (displaced 4 8 get-cert 4) ra-1 (7 0))
  (strand-map 0 1 2 3 7 4 5 6)
