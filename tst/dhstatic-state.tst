...
(defskeleton dhstatic-state
  ...
  (uniq-gen ra)
  (gen-st (cat "privkey" a ra serial-a ca))
  (facts (neq a b) (neq b a) (trans 1 3) (trans 1 2))
...
(defskeleton dhstatic-state
  ...
  (uniq-gen ra)
  (gen-st (cat "privkey" a ra serial-a ca))
  (facts (neq a a) (trans 1 3) (trans 1 2))
...
(defskeleton dhstatic-state
  ...
  (facts (neq a a) (trans 4 3) (trans 1 3) (trans 4 2) (trans 1 2))
  (rule fact-resp-neq0 trRl_get-cert-at-2 trRl_get-cert-at-3)
  (operation channel-test (added-strand get-cert 4)
    (ch-msg static-key-0 (cat pt-1 "privkey" a ra-0 serial-a ca-0))
    (3 0))
...
(defskeleton dhstatic-state
  ...
  (facts (neq a a) (trans 5 3) (trans 1 3) (trans 5 2) (trans 1 2))
  (rule fact-resp-neq0 trRl_get-cert-at-2 trRl_get-cert-at-3)
  (operation channel-test (added-strand get-cert 4)
...
(defskeleton dhstatic-state
  ...
  (gen-st (cat "privkey" b ra-0 serial-b ca)
    (cat "privkey" a ra serial-a ca))
  (facts (neq a b) (neq b a) (trans 5 3) (trans 1 3) (trans 5 2)
    (trans 1 2))
  (rule fact-resp-neq0 trRl_get-cert-at-2 trRl_get-cert-at-3)
...
(defskeleton dhstatic-state
  ...
  (gen-st (cat "privkey" b ra-1 serial-b ca-0)
    (cat "privkey" a ra serial-a ca))
  (facts (neq a b) (neq b a) (trans 6 3) (trans 1 3) (trans 6 2)
    (trans 1 2))
  (rule fact-resp-neq0 trRl_get-cert-at-2 trRl_get-cert-at-3)
  (operation channel-test (added-strand get-cert 4)
...
(defskeleton dhstatic-state
  ...
  (uniq-gen ra ra-0)
  (gen-st (cat "privkey" a ra serial-a ca))
  (facts (neq a self) (neq self a) (trans 6 3) (trans 1 3) (trans 6 2)
    (trans 1 2))
  (rule fact-init-neq0 fact-resp-neq0 trRl_get-cert-at-2
    trRl_get-cert-at-3)
...
(defskeleton dhstatic-state
  ...
  (facts (neq a self) (neq self a) (trans 7 3) (trans 5 3) (trans 1 3)
    (trans 7 2) (trans 5 2) (trans 1 2))
  (rule fact-resp-neq0 trRl_get-cert-at-2 trRl_get-cert-at-3)
...
(defskeleton dhstatic-state
  ...
  (facts (neq b a) (neq a b) (trans 1 3) (trans 1 2))
  (rule fact-init-neq0 fact-resp-neq0 trRl_get-cert-at-2
    trRl_get-cert-at-3)
  (operation channel-test (added-strand get-cert 4)
...
(defskeleton dhstatic-state
  ...
  (uniq-gen ra)
  (gen-st (cat "privkey" b ra serial-b ca))
  (facts (neq b b) (trans 1 3) (trans 1 2))
  (rule fact-resp-neq0 trRl_get-cert-at-2 trRl_get-cert-at-3)
  (operation encryption-test (displaced 3 2 cert 2)
...
(defskeleton dhstatic-state
  ...
  (gen-st (cat "privkey" b ra serial-b ca)
    (cat "privkey" b ra-0 serial-b ca-0))
  (facts (neq b b) (trans 4 3) (trans 1 3) (trans 4 2) (trans 1 2))
  (rule fact-resp-neq0 trRl_get-cert-at-2 trRl_get-cert-at-3)
  (operation channel-test (added-strand get-cert 4)
    (ch-msg static-key-0 (cat pt-1 "privkey" b ra-0 serial-b ca-0))
    (3 0))
...
(defskeleton dhstatic-state
  ...
  (gen-st (cat "privkey" b ra serial-b ca)
    (cat "privkey" b ra-0 serial-a ca-0))
  (facts (neq b b) (trans 5 3) (trans 1 3) (trans 5 2) (trans 1 2))
  (rule fact-resp-neq0 trRl_get-cert-at-2 trRl_get-cert-at-3)
  (operation channel-test (added-strand get-cert 4)
...
(defskeleton dhstatic-state
  ...
  (gen-st (cat "privkey" a ra-0 serial-a ca)
    (cat "privkey" b ra serial-b ca))
  (facts (neq b a) (neq a b) (trans 5 3) (trans 1 3) (trans 5 2)
    (trans 1 2))
  (rule fact-resp-neq0 trRl_get-cert-at-2 trRl_get-cert-at-3)
  (operation channel-test (displaced 4 6 get-cert 4)
...
(defskeleton dhstatic-state
  ...
  (gen-st (cat "privkey" a ra-1 serial-a ca-0)
    (cat "privkey" b ra serial-b ca))
  (facts (neq b a) (neq a b) (trans 6 3) (trans 1 3) (trans 6 2)
    (trans 1 2))
  (rule fact-resp-neq0 trRl_get-cert-at-2 trRl_get-cert-at-3)
  (operation channel-test (added-strand get-cert 4)
...
(defskeleton dhstatic-state
  ...
  (uniq-gen ra ra-0)
  (gen-st (cat "privkey" b ra serial-b ca))
  (facts (neq b self) (neq self b) (trans 6 3) (trans 1 3) (trans 6 2)
    (trans 1 2))
  (rule fact-init-neq0 fact-resp-neq0 trRl_get-cert-at-2
    trRl_get-cert-at-3)
  (operation nonce-test (displaced 4 7 get-cert 4) ra-0 (6 0))
...
(defskeleton dhstatic-state
  ...
  (facts (neq b self) (neq self b) (trans 7 3) (trans 5 3) (trans 1 3)
    (trans 7 2) (trans 5 2) (trans 1 2))
  (rule fact-resp-neq0 trRl_get-cert-at-2 trRl_get-cert-at-3)
  (operation nonce-test (displaced 4 8 get-cert 4) ra-1 (7 0))
  (traces
