...
(defskeleton yahalom
  (vars (k k-0 skey) (n-b n-a n-a-0 text) (a b c a-0 b-0 c-0 name))
  (defstrand resp 4 (k k) (n-a n-a) (n-b n-b) (b b) (a a) (c c))
  (defstrand serv 3 (k k) (n-a n-a) (n-b n-b) (c c) (a a) (b b))
  (defstrand init 3 (k k) (n-a n-a-0) (n-b n-b) (a a-0) (b b-0) (c c-0))
...
(defskeleton yahalom
  (vars (k k-0 skey) (n-b n-a n-a-0 n-b-0 n-a-1 text)
    (a b c a-0 b-0 c-0 name))
  (defstrand resp 4 (k k) (n-a n-a) (n-b n-b) (b b) (a a) (c c))
  (defstrand serv 3 (k k) (n-a n-a-0) (n-b n-b-0) (c c) (a a) (b b))
  (defstrand resp 2 (n-a n-a-0) (n-b n-b-0) (b b) (a a) (c c))
...
(defskeleton yahalom
  (vars (k k-0 skey) (n-b n-a text) (a b c name))
  (defstrand resp 4 (k k) (n-a n-a) (n-b n-b) (b b) (a a) (c c))
  (defstrand serv 3 (k k) (n-a n-a) (n-b n-b) (c c) (a a) (b b))
  (defstrand init 3 (k k) (n-a n-a) (n-b n-b) (a a) (b b) (c c))
  (defstrand serv 2 (k k-0) (n-a n-a) (n-b n-b) (c c) (a a) (b b))
  ...
  (parent 10)
  (seen 8)
  (seen-opts (8 (operation generalization deleted (3 0))))
  (realized)
...
(defskeleton yahalom
  ...
  (parent 17)
  (seen 16)
  (seen-opts (16 (operation generalization deleted (4 0))))
  (realized)
  (comment "1 in cohort - 0 not yet seen"))

(defskeleton yahalom
  (vars (k k-0 k-1 skey) (n-b n-a n-a-0 text) (a b c a-0 b-0 c-0 name))
  (defstrand resp 4 (k k) (n-a n-a) (n-b n-b) (b b) (a a) (c c))
  (defstrand serv 3 (k k) (n-a n-a) (n-b n-b) (c c) (a a) (b b))
  (defstrand init 3 (k k) (n-a n-a-0) (n-b n-b) (a a-0) (b b-0) (c c-0))
  (defstrand serv 2 (k k-0) (n-a n-a) (n-b n-b) (c c) (a a) (b b))
...
(defskeleton yahalom
  (vars (k k-0 k-1 skey) (n-b n-a n-a-0 n-b-0 n-a-1 text)
    (a b c a-0 b-0 c-0 name))
  (defstrand resp 4 (k k) (n-a n-a) (n-b n-b) (b b) (a a) (c c))
  (defstrand serv 3 (k k) (n-a n-a-0) (n-b n-b-0) (c c) (a a) (b b))
  (defstrand resp 2 (n-a n-a-0) (n-b n-b-0) (b b) (a a) (c c))
...
(defskeleton yahalom
  (vars (k k-0 k-1 skey) (n-b n-a text) (a b c name))
  (defstrand resp 4 (k k) (n-a n-a) (n-b n-b) (b b) (a a) (c c))
  (defstrand serv 3 (k k) (n-a n-a) (n-b n-b) (c c) (a a) (b b))
  (defstrand init 3 (k k) (n-a n-a) (n-b n-b) (a a) (b b) (c c))
  (defstrand serv 2 (k k-0) (n-a n-a) (n-b n-b) (c c) (a a) (b b))
...
(defskeleton yahalom
  ...
  (defstrand init 3 (k k-0) (n-a n-a) (n-b n-b) (a a) (b b) (c c))
  (deflistener k-0)
  (defstrand serv 3 (k k-0) (n-a n-a) (n-b n-b) (c c) (a a) (b b))
...
(defskeleton yahalom
  ...
  (parent 30)
  (seen 28)
  (seen-opts (28 (operation generalization deleted (4 0))))
  (realized)
  (comment "1 in cohort - 0 not yet seen"))
...
(defskeleton yahalom
  ...
  (parent 34)
  (seen 16)
  (seen-opts (16 (operation generalization deleted (3 0))))
  (realized)
  (comment "1 in cohort - 0 not yet seen"))
...
(defskeleton yahalom
  ...
  (parent 48)
  (seen 28)
  (seen-opts (28 (operation generalization deleted (3 0))))
  (realized)
  (comment "1 in cohort - 0 not yet seen"))
