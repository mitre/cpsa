...
(defskeleton subatomic-open-closed
  ...
  (conf start-ch)
  (auth start-ch)
  (facts (trans 3 2) (trans 3 3) (same-dev ls lk) (trans 1 4)
...
(defskeleton subatomic-open-closed
  (vars (old old1 any old-0 old1-0 mesg) (n n-0 text) (d o name)
    (k k-0 skey) (start-ch start-ch-0 chan) (lk ls locn))
  (defstrand dev-pass 4 (n n) (d d) (o o) (k k) (lk lk) (ls ls))
  (defstrand dev-up 5 (old old) (old1 old1) (d d) (o o) (k k)
    (start-ch start-ch) (lk lk) (ls ls))
  (defstrand owner-power-dev 1 (d d) (o o) (k k) (start-ch start-ch))
  ...
  (facts (trans 4 4) (trans 4 1) (trans 4 2) (trans 4 3)
    (same-dev ls lk) (trans 3 2) (trans 3 3) (trans 1 4) (trans 1 1)
    (trans 1 2) (trans 1 3) (no-state-split))
...
(defskeleton subatomic-open-closed
  ...
  (conf start-ch)
  (auth start-ch)
  (facts (trans 3 2) (trans 3 3) (same-dev ls lk) (trans 2 4)
...
(defskeleton subatomic-open-closed
  ...
  (auth start-ch start-ch-0)
  (facts (trans 4 4) (trans 4 1) (trans 4 2) (trans 4 3)
    (same-dev ls lk) (trans 3 2) (trans 3 3) (trans 2 4) (trans 2 1)
    (trans 2 2) (trans 2 3) (no-state-split))
  (rule cau-dev-up-2 eff-dev-up-3 trRl_dev-up-at-4 invShearsRule
    same-dev-lk-ls trRl_dev-up-at-1 trRl_dev-up-at-2 trRl_dev-up-at-3
    fact-dev-up-same-dev0)
  (operation channel-test (added-strand dev-up 4)
...
(defskeleton subatomic-open-closed
  ...
  (conf start-ch)
  (auth start-ch)
  (facts (trans 2 2) (trans 2 3) (same-dev ls lk) (trans 5 4)
...
(defskeleton subatomic-open-closed
  ...
  (conf start-ch start-ch-0)
  (auth start-ch start-ch-0)
  (facts (trans 3 4) (trans 3 1) (trans 3 2) (trans 3 3)
    (same-dev ls lk) (trans 2 2) (trans 2 3) (trans 6 4) (trans 6 1)
    (trans 6 2) (trans 6 3) (no-state-split))
