...
(defskeleton subatomic-open-closed
  ...
  (defstrand dev-open 4 (any any) (n n-0) (d d) (o o) (k k-0) (lk lk)
    (ls ls))
  (precedes ((1 3) (3 1)) ((1 4) (3 2)) ((2 0) (1 0)) ((3 3) (0 0)))
  (uniq-orig n)
...
(defskeleton subatomic-open-closed
  ...
  (defstrand dev-open 4 (any any) (n n-0) (d d) (o o) (k k-0) (lk lk)
    (ls ls))
  (precedes ((1 4) (3 2)) ((2 0) (1 0)) ((2 0) (3 1)) ((3 3) (0 0)))
  (uniq-orig n)
  (genStV (cat "st" d o o) (cat "st-k" d o k) (cat "st-k" d o k-0))
  (conf start-ch)
  (auth start-ch)
...
(defskeleton subatomic-open-closed
  ...
  (defstrand dev-open 4 (any any) (n n-0) (d d) (o o) (k k-0) (lk lk)
    (ls ls))
  (precedes ((0 0) (2 0)) ((2 3) (3 1)) ((2 4) (3 2)) ((3 3) (1 0)))
  (uniq-orig n k)
  (genStV (cat "st" d o o) (cat "st-k" d o k) (cat "st-k" d o k-0))
  (conf start-ch)
  (auth start-ch)
...
(defskeleton subatomic-open-closed
  ...
  (defstrand dev-open 4 (any any) (n n-0) (d d) (o o) (k k-0) (lk lk)
    (ls ls))
  (precedes ((0 0) (2 0)) ((0 0) (3 1)) ((2 4) (3 2)) ((3 3) (1 0)))
  (uniq-orig n k)
  (genStV (cat "st" d o o) (cat "st-k" d o k) (cat "st-k" d o k-0))
  (conf start-ch)
  (auth start-ch)
