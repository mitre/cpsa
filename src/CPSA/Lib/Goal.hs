...
aFormOrder (Non _) (StrPrec _ _) = LT
aFormOrder (Non _) (Prec _ _) = LT
...
aFormOrder (Pnon _) (StrPrec _ _) = LT
aFormOrder (Pnon _) (Prec _ _) = LT
...
aFormOrder (UniqAt _ _) (StrPrec _ _) = LT
aFormOrder (UniqAt _ _) (Prec _ _) = LT
...
aFormOrder (UgenAt _ _) (StrPrec _ _) = LT
aFormOrder (UgenAt _ _) (Prec _ _) = LT
...
aFormOrder (Ugen _) (StrPrec _ _) = LT
aFormOrder (Ugen _) (Prec _ _) = LT
aFormOrder (Ugen _) (Equals _ _) = LT
aFormOrder (StrPrec _ _) (RolePred _ _ _) = GT
aFormOrder (StrPrec _ _) (ParamPred _ _ _ _) = GT
aFormOrder (StrPrec _ _) (Non _) = GT
aFormOrder (StrPrec _ _) (Pnon _) = GT
aFormOrder (StrPrec _ _) (UniqAt _ _) = GT
aFormOrder (StrPrec _ _) (UgenAt _ _) = GT
aFormOrder (StrPrec _ _) (Ugen _) = GT
...
aFormOrder (Prec _ _) (Non _) = GT
aFormOrder (Prec _ _) (Pnon _) = GT
aFormOrder (Prec _ _) (UniqAt _ _) = GT
aFormOrder (Prec _ _) (UgenAt _ _) = GT
aFormOrder (Prec _ _) (Ugen _) = GT
